...
void utils::mouse::aim_at(float x, float y)
{
    ...
    if (settings::aimbot::speed == 0) settings::aimbot::speed = 1;
    ...
    if (x != 0)
    {
        if (x > ScreenCenterX)
        {
            TargetX = (x - ScreenCenterX) * settings::aimbot::speed;
            if (TargetX + ScreenCenterX > ScreenCenterX * 2) TargetX = 0;
        }

        if (x < ScreenCenterX)
        {
            TargetX = -(ScreenCenterX - x) * settings::aimbot::speed;
    ...
    if (y != 0)
    {
        if (y > ScreenCenterY)
        {
            TargetY = (y - ScreenCenterY) * settings::aimbot::speed;
            if (TargetY + ScreenCenterY > ScreenCenterY * 2) TargetY = 0;
        }

        if (y < ScreenCenterY)
        {
            TargetY = -(ScreenCenterY - y) * settings::aimbot::speed;
