...
// this fixes bsod on some systems, bc windows not always allocate memory for efi driver so we need to do it ourselves
#define DRIVER_SIZE 2097152 // 2mb should be enough
#pragma section(".text")
__declspec(allocate(".text")) char DriverBuffer[DRIVER_SIZE];
