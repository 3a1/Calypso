...
uintptr_t readOffset(const std::string& name, const std::string& path) 
{
...
bool readOffsets() 
{
    offsets::dwEntityList = readOffset("dwEntityList", "offsets/offsets.json");
    offsets::dwLocalPlayerPawn = readOffset("dwLocalPlayerPawn", "offsets/offsets.json");
    offsets::dwViewMatrix = readOffset("dwViewMatrix", "offsets/offsets.json");

    offsets::m_iIDEntIndex = readOffset("m_iIDEntIndex", "offsets/client.dll.json");
    offsets::m_hPlayerPawn = readOffset("m_hPlayerPawn", "offsets/client.dll.json");
    offsets::m_iTeamNum = readOffset("m_iTeamNum", "offsets/client.dll.json");
    offsets::m_iHealth = readOffset("m_iHealth", "offsets/client.dll.json");
    offsets::m_vecOrigin = readOffset("m_vecOrigin", "offsets/client.dll.json");
